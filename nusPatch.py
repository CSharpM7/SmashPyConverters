...
def findSource():
    if root.modFile == "":
        return
    filePath = root.modFile[root.modFile.index("sound/"):]
...
def run():    
    ...
    patchFile = root.modFile.replace("nus3audio","patch3audio")

    subcall = ["nus3audio_patcher.exe",root.sourceFile,root.modFile]
